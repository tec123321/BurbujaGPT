...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView title = makeText("BurbujaGPT V9", 28, COLOR_TEXT, true);
        ...
        infoCard.addView(makeText(
                "El panel conserva la misma pagina mientras el servicio esta activo. V9 reduce el uso de memoria del WebView y lo reconstruye automaticamente si Android detiene su motor. Para cuentas iniciadas con Google, el acceso incrustado sigue bloqueado por Google: usa correo y contrasena, la app oficial o el navegador.",
                14,
                COLOR_TEXT,
                false
        ), matchWrap());
